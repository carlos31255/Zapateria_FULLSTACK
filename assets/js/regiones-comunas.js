// Arreglo principal con todas las regiones y sus comunas
const regionesComunas = {
    ...
    "Valparaíso": [
        ...
        "Putaendo", "Santa María", "Limache", "Olmué", "Villa Alemana", "Quilpué"
    ],
    "Metropolitana de Santiago": [
        ...
        "Renca", "Santiago", "San Joaquín", "San Miguel", "San Ramón", "Vitacura", 
    ...
    "Maule": [
        ...
        "Pencahue", "Río Claro", "San Clemente", "San Rafael", "Curicó", "Hualañé", 
        "Licantén", "Molina", "Rauco", "Romeral", "Sagrada Familia", "Teno", 
        "Vichuquén", "Linares", "Colbún", "Longaví", "Parral", "Retiro", 
        "San Javier", "Villa Alegre", "Yerbas Buenas", "Cauquenes", "Chanco", 
        "Pelluhue"
    ],
    "Ñuble": [
...
// Función para obtener solo las regiones
function obtenerRegiones() {
    return Object.keys(regionesComunas);
}
...
// Función para poblar select de regiones
function poblarSelectRegiones(selectElement) {
    // Limpiar opciones existentes
    selectElement.innerHTML = '<option value="">Selecciona una región</option>';
...
// Función para poblar select de comunas basado en región seleccionada
function poblarSelectComunas(selectElement, region) {
    // Limpiar opciones existentes
